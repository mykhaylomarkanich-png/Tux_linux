...
const HELP_MESSAGE = `
tux, windows, вінда, віндовс, вікно, лінукс, опен сурс, пінг, пінгвін, васька, василь, володьо, встає, встав, привіт, нет, нахуй,пизда, хуй, кнш, щось, астрольфо, камера, тукс, android in the bios`;
